...
struct Vertex* makeTankBody(GLdouble width, GLdouble height, GLdouble length, glm::vec3 colour) {
	...
	}
	{
		...
		a = new GLdouble[3]{ -l, -w, h };
		b = new GLdouble[3]{ -l / 2, -w, h };
		c = new GLdouble[3]{ -l / 2, -w, h * 2 };
		norm = getNormal(a, b, c);
	...
	}
	{
		...
		a = new GLdouble[3]{ -l, w, h };
		b = new GLdouble[3]{ -l / 2, w, h * 2 };
		c = new GLdouble[3]{ -l / 2, w, h };
		norm = getNormal(a, b, c);
	...
	} 
	{
		...
		a = new GLdouble[3]{ -l / 2, -w, h };
		b = new GLdouble[3]{ l, -w, h };
		c = new GLdouble[3]{ -l / 2, -w, h * 2 };
		norm = getNormal(a, b, c);
		...
		a = new GLdouble[3]{ -l / 2, -w, h * 2 };
		b = new GLdouble[3]{ l, -w, h };
		c = new GLdouble[3]{ l, -w, h * 2 };
		norm = getNormal(a, b, c);
